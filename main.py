...
if uploaded_file:
    ...
    with st.spinner("Summarizing your resume..."):
        summary = ask_openai(
            f"Summarize this resume in under 200 words. "
            f"Highlight the skills, education, and experience clearly. "
            f"Do not explain your reasoning or thought process.\n\n{resume_text}",
    ...
    with st.spinner("Finding skill Gaps..."):
        gaps = ask_openai(
            f"Analyze this resume and list the missing skills, certifications, and experiences "
            f"that would improve job opportunities. Keep the answer under 150 words. "
    ...
    with st.spinner("Creating Future Roadmap..."):
        roadmap = ask_openai(
            f"Based on this resume, suggest a career roadmap in under 200 words. "
            f"Include skills to learn, certifications to pursue, and industry exposure needed. "
            f"Do not explain your reasoning.\n\n{resume_text}",
            max_completion_tokens=4000
        )
